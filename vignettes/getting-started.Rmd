...
```{r create-source}
# Create an epidata source for COVID-19 hospital admissions
source <- epidata_source(
  target = "covid",
  geo_types = "state"
)
```
...
reference_dates <- seq(
  as.Date("2025-10-25"),  # First Saturday of 2024
  as.Date("2025-12-27"),  # Last Saturday of March
  by = "week"
)
